...
export const GenreSelectorEdit: React.FC<GenreSelectorEditProps> = ({ filteredGenres, genreFilter, onFilter, selectedGenres, toggleGenre, error }) => {
  return (
...
export default GenreSelectorEdit;
