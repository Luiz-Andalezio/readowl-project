...
const InputWithIcon: React.FC<InputWithIconProps> = ({ icon, className = "", error, rightIcon, hideErrorText, ...props }) => (
  <div className="relative mb-4">
    ...
    <input
      className={`w-full pl-10 pr-4 py-2 rounded-full bg-white border-2 ${error ? "border-red-400 animate-shake" : "border-none"} focus:ring-2 focus:ring-readowl-purple-light text-readowl-purple placeholder-readowl-purple placeholder-opacity-50  ${className}`}
      {...props}
    />
