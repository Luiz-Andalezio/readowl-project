          ...
          >
            ...
            <div className="flex items-center gap-2 ml-2">
              {editing[v.id] !== undefined ? null : (
                <>
                  <button onMouseDown={(e) => e.stopPropagation()} onPointerDown={(e) => e.stopPropagation()} onClick={(e) => { e.stopPropagation(); setOpen(true); setEditing(prev => ({ ...prev, [v.id]: v.title })); }} aria-label="Editar" className="p-1"><Pencil size={18} className="text-readowl-purple-medium" /></button>
                  <button
                    onMouseDown={(e) => e.stopPropagation()}
                    onPointerDown={(e) => e.stopPropagation()}
                    onClick={(e) => {
                    ...
                    className="p-1"
                  >
                    <Trash2 size={18} className="text-readowl-purple-medium" />
                  </button>
                </>
              )}
            </div>
